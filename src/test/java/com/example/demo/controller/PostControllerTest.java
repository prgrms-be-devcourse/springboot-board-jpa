        ...
        mockMvc.perform(RestDocumentationRequestBuilders.get("/posts")
                ...
                .andDo(document("get-all",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.content[].id").type(JsonFieldType.NUMBER).description("post[].id"),
                                fieldWithPath("data.content[].title").type(JsonFieldType.STRING).description("post[].title"),
                                fieldWithPath("data.content[].content").type(JsonFieldType.STRING).description("post[].content"),
                                fieldWithPath("data.content[].userDto.id").type(JsonFieldType.NUMBER).description("post[].userDto.id"),
                                fieldWithPath("data.content[].userDto.name").type(JsonFieldType.STRING).description("post[].userDto.name"),
                                fieldWithPath("data.content[].userDto.age").type(JsonFieldType.NUMBER).description("post[].userDto.age"),
                                fieldWithPath("data.content[].userDto.hobby").type(JsonFieldType.STRING).description("post[].userDto.hobby"),
