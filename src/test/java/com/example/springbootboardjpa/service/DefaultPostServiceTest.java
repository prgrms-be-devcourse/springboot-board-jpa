...
class DefaultPostServiceTest {
    ...
    public void updateFailTest() {
        ...
        assertThat(exception.getMessage()).isEqualTo(ERROR_MSG +"title 유효 글자 수를 초과하였습니다.");
//        assertThat(postRepository.findById(save.getId()).get().getTitle()).isEqualTo("test_title");
//        assertThat(postRepository.findById(save.getId()).get().getContent()).isEqualTo("content");
    }
