...
class PostControllerTest {
    ...
    void createPostTest() throws Exception {
        given(postService.createPost(any(PostCreateRequest.class))).willReturn(new IdResponse(post.getId()));
    ...
    void findPostTest() throws Exception {
        given(postService.findPost(anyLong())).willReturn(new PostFindResponse(post));
    ...
    void modifyPostTest() throws Exception {
        given(postService.modifyPost(anyLong(), any(PostModifyRequest.class))).willReturn(new IdResponse(post.getId()));

        String body = objectMapper.writeValueAsString(new PostModifyRequest("안녕하세요", "반갑습니다"));
    ...
    void removePostTest() throws Exception {
        given(postService.removePost(anyLong())).willReturn(new IdResponse(post.getId()));
