...
class MemberServiceTest {
	...
	void setUp() {
		...
		redisService.setEmail("test@naver.com", "123456", 60000L, "SIGN-UP");
		redisService.setEmail("user123@naver.com", "234567", 60000L, "RESET-PASSWORD");
	}

	@AfterEach
	void tearDown() {
		redisService.deleteEmail("test@naver.com", "SIGN-UP");
		redisService.deleteEmail("user123@naver.com", "RESET-PASSWORD");
	}
